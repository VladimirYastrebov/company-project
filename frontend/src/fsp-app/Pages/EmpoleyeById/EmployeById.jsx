...
import { ArrowLeft, Calendar, Clock, DollarSign, IdCard, TrendingUp, User, Users, CheckCircle, XCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 px-4 py-6 text-slate-100">
      <div className="mx-auto w-full max-w-5xl">
        <div className="mb-6 flex items-center justify-between rounded-2xl border border-slate-800 bg-slate-900/80 px-5 py-4">
          <Link to="/" className="inline-flex items-center gap-1.5 text-blue-400 font-semibold transition hover:text-blue-300">
            <ArrowLeft className="h-4 w-4" />
            Back to employees
          </Link>
        ...
        <section className="rounded-2xl border border-slate-800 bg-linear-to-b from-slate-900 to-slate-900/70 p-6 md:p-8 shadow-2xl shadow-blue-950/30">
          <div className="mb-4 flex items-center justify-center gap-1.5 text-slate-200">
            ...
            <span className="text-sm font-medium tracking-wide">SMTH Employee Manager</span>
          </div>
          ...
          <h2 className="mt-6 text-center text-4xl font-bold tracking-tight">Employee Details</h2>
              ...
              <div className="flex items-center gap-2">
                <p
                  className={`text-xl font-semibold ${
                    employee.upping_salary ? "text-emerald-400" : "text-rose-400"
                  }`}
                >
